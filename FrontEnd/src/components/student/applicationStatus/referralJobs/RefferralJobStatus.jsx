          ...
          <div className="w-full md:w-64 bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg shadow-purple-50/50 overflow-y-auto mr-0 md:mr-6">
            {filteredJobs?.length > 0 ? filteredJobs?.map(job => (
              ...
              >
                ...
                <h3 className="font-medium text-gray-900 mt-2">{job.jobDetails[0].jobTitle}</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg shadow-purple-50/50 p-6">
                  <div className="flex justify-between">
                    <div>
                      <h2 className="text-xl font-semibold bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent">{selectedJob.jobDetails[0].jobTitle}</h2>
                  ...
                  <div className="mt-4">
                    <Link 
                      to={`/professional-dashboard/Referral/${selectedJob?.jobDetails[0]?._id}?isApplied=true`} 
