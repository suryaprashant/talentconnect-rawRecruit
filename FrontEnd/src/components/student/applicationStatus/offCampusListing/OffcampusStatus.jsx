  ...
  const fetchApplication = async () => {
    try {
      ...
      const normalized = rawData.map((item) => {
        ...
        // Build a safe job details entry ensuring UI-accessed props exist
        ...
        <div className="w-64 bg-white border-r border-gray-200 overflow-y-auto">
          {filteredJobs?.map(job => (
            ...
            >
              ...
              <h3 className="font-medium">{job.jobDetails[0].jobRoles[0]}</h3>
            ...
            <>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                <div className="flex justify-between">
                  <div>
                    <h2 className="text-xl font-semibold text-gray-800">{selectedJob.jobDetails[0].jobRoles[0]}</h2>
