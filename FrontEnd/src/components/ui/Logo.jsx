...
//         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#143694" className="w-6 h-6">
...
//         </svg>
//       </div>
//       <span className="text-xl font-bold bg-gradient-to-r from-[#143694] to-[#1e4ed8] bg-clip-text text-transparent">
//         RawRecruit
//       </span>
//     </div>
//   )
