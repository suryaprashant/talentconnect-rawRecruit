...
const ShortlistDrive = ({
  ...
  const handleManageDrive = (driveId) => {
    navigate(`/accepted/pool-campus-listings/${driveId}`);
  };
      ...
      <div className="p-4">
        <div className="flex justify-between items-start">
          ...
          <span className={`text-xs px-2 py-1 rounded-full ${
            drive.status === 'Accepted' ? 'bg-gray-100 text-gray-600' : 
        ...
        <div className="mt-2 flex items-center gap-2 text-gray-600">
          ...
          <span className="text-sm">{drive.applicant?.college?.collegeLocation} {drive.applicant?.college?.city} {drive.applicant?.college?.state}</span>
        </div>
