...
const PoolCampusDrives = ({
  ...
  const handleManageDrive = (driveId) => {
    navigate(`/shortlisted/pool-campus-listings/${driveId}`);
  };
      ...
      <div className="p-4">
        ...
        <div className="mt-3 flex flex-col justify-between ">
          ...
          <button 
            ...
            className="bg-black text-white py-2 px-4 mt-4 rounded-md text-sm hover:bg-gray-800 transition-colors"
          >
...
export default PoolCampusDrives;