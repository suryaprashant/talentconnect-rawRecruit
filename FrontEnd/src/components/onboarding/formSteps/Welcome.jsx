        ...
        <div className="bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg shadow-purple-50/50 p-8 w-full max-w-xl">
          ...
          <div className="text-center mb-6">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-r from-[#143694]/20 to-[#1e4ed8]/20 flex items-center justify-center mx-auto mb-4">
              <FiUser className="w-10 h-10 text-[#143694]" />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-end">
            ...
            <button
              onClick={onNext}
              className="flex items-center justify-center px-6 py-3 bg-gradient-to-r from-[#143694] to-[#1e4ed8] text-white rounded-xl hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-200 font-medium"
            >
              Continue
