...
export const ProfessionalDetailsStep = ({ onNext, onBack, formData, onChange }) => {
  ...
  // Derive current company from experiences (set in ProfessionalStepFour)
  const currentExperience = (formData.experiences || []).find((e) => e.isCurrent);
  const currentCompanyName = currentExperience?.company || formData.currentCompany || "";
        ...
        <form className="w-full text-base font-normal mt-8 max-md:max-w-full">
          ...
          <div className="w-full">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white flex min-h-12 w-full p-3 border border-gray-300 rounded focus:ring-2 focus:ring-black focus:border-black"
              >
          ...
          <div className="w-full mt-6">
            <div className="flex items-center gap-3">
              ...
              />
              <label htmlFor="servingNoticePeriod" className="text-black font-medium select-none">
