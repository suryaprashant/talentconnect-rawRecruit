        ...
        <div className="bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg shadow-purple-50/50 p-8 w-full max-w-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center gap-2 mb-2">
              <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-[#143694] to-[#1e4ed8] bg-clip-text text-transparent">
                Career Preferences
              </h1>
              {!isEditable && (
                <button
                  onClick={handleEditClick}
                  className="p-2 rounded-full bg-gradient-to-r from-[#143694]/10 to-[#1e4ed8]/10 hover:from-[#143694]/20 hover:to-[#1e4ed8]/20 transition-all duration-200"
                >
                  <Edit2 className="w-4 h-4 text-[#143694]" />
                </button>
              )}
            </div>
                  ...
                  <select
                    ...
                    className={`appearance-none w-full p-4 border rounded-xl focus:outline-none transition-all duration-200 pr-10 ${
                      !isEditable 
                        ...
                        : "border-gray-300 hover:border-[#143694] focus:border-[#143694] focus:shadow-[0_0_0_3px_rgba(102,126,234,0.1)] text-gray-700"
                    }`}
                  >
                    ...
                    className={`p-3 border rounded-xl transition-all duration-200 font-medium ${
                      formData.lookingFor === option
                        ? isEditable
                          ...
                          : "bg-gradient-to-r from-[#143694]/60 to-[#1e4ed8]/60 text-white border-transparent"
                        : "text-gray-700 border-gray-300"
                    } ${!isEditable ? "cursor-not-allowed" : "hover:border-[#143694] hover:bg-gradient-to-r hover:from-[#143694]/5 hover:to-[#1e4ed8]/5"}`}
                  >
            ...
            <div className="flex gap-3">
              {!isEditable && (
                <button
                  type="button"
                  onClick={handleEditClick}
                  className="flex items-center justify-center px-8 py-3 bg-gradient-to-r from-[#143694]/10 to-[#1e4ed8]/10 border border-[#143694]/30 rounded-xl text-[#5b21b6] hover:bg-gradient-to-r hover:from-[#143694]/20 hover:to-[#1e4ed8]/20 hover:shadow-md transition-all duration-200 font-medium"
                >
