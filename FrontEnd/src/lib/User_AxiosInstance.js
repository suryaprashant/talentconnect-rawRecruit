...
export function viewed(jobId) {
  return axiosClient
    .post(`/api/hiring-channels/view/${jobId}`)
...
export function getJobLisingJobDetails(jobId) {
  return axiosClient
    .get(`/jobs/jobDetails/joblisting/${jobId}`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function getReferalJobDetails(jobId) {
  return axiosClient
    .get(`/jobs/jobDetails/referral/${jobId}`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function getRelaventOffcampusOpportunity() {
  return axiosClient
    .get(`/api/student-dashboard/off-campus`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function getRelaventJobListingOpportunity() {
  return axiosClient
    .get(`/api/student-dashboard/job-postings`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function getAllInternship() {
  return axiosClient
    .get(`/api/student-dashboard/internship-postings`)
    .then((response) => response)
    .catch((error) => error);
}
...
//   return axiosClient
//     .get(`/internship/getInternshipDetail/${Id}`)
//     .then((response) => response)
//     .catch((error) => error);
// }
...
export function getInternshipDetail(Id) {
  return axiosClient
    .get(`/api/student-dashboard/getPoolCampusJob/${Id}`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function getInternshipById(internshipId) {
  return axiosClient
    .get(`/api/student-dashboard/getInternshipDetail/${internshipId}`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function getEventApplicationStatus() {
  return axiosClient
    .get(`/eventParticipation/byParticipent`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function ApplyForOppurtunity(jobId) {
  return axiosClient
    .post(`/application/candidate/offcampus`, { jobId: jobId })
    .then((response) => response)
    .catch((error) => error);
}
...
export function ApplyForJobListingOppurtunity(jobId) {
  return axiosClient
    .post(`/application/candidate/joblisting`, { jobId: jobId })
    .then((response) => response)
    .catch((error) => error);
}
...
export function ApplyForInternship(internshipId) {
  return axiosClient
    .post(`/application/candidate/internship`, { internshipId: internshipId })
    .then((response) => response)
    .catch((error) => error);
}
...
export function ApplyForReferral(referralId) {
  return axiosClient
    .post(`/application/candidate/referral`, { referralId: referralId })
    .then((response) => response)
    .catch((error) => error);
}
...
export function getUserApplicationStatus(jobType) {
  return axiosClient
    .get(`/application/status/candidate/${jobType}`)
    .then((response) => response)
    .catch((error) => error);
}
...
export const postReferralJob = (jobData) => {
  return axiosClient
    .post("/api/hiring-channels/referral-posting", jobData)
...
export function getReferralJobListing() {
  return axiosClient
    .get(`/api/student-dashboard/referral-jobs`)
    .then((response) => response)
...
export function getReferralJobById(referralJob) {
  return axiosClient
    .get(`api/student-dashboard/referral-jobs/${referralJob}`)
    .then((response) => response)
    .catch((error) => error);
}
...
export function createCounsellingRequest(formData) {
  return axiosClient
    .post("/api/servicerequests/student/counselling", formData)
    .then((response) => response)
    .catch((error) => error);
}
...
export function createMockInterviewRequest(formData) {
  return axiosClient
    .post("/api/servicerequests/student/mock-interview", formData)
    .then((response) => response)
    .catch((error) => error);
}

// NEW: allow default import (used by Dashboard.jsx)
