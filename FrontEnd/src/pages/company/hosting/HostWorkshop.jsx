    ...
    const loadWorkshopData = async () => {
      if (editMode && eventId) {
        ...
        try {
          ...
          console.log('Fetching workshop data from API');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201 || response.status === 200 || response?.data?.success) {
       ...
       const errorMessage =
         err.response?.data?.message || (isEditMode ? "Failed to update workshop." : "Failed to create workshop.");
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg p-6 mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-md text-gray-600 max-w-2xl mx-auto">
              {isEditMode 
                ? 'Update your workshop event details to engage with talented developers and innovators.'
            ...
            <>
              ...
              <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Workshop Sub-Title <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      name="subTitle"
