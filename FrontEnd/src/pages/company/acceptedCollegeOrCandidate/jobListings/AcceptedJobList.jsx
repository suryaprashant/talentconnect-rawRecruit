...
export default function OffCampusJobManagement() {
    ...
    const fetchJobs = async () => {
        try {
            const response = await getPostedJobs("Job-listing", "Accepted");
        ...
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto p-4 bg-white">
                <div className="flex justify-between items-center mt-10 mb-4">
                    <div>
                        <h1 className="text-3xl font-bold">Accepted Job-listing Applications</h1>
                        <p className="text-gray-600 mt-2">Track Your Job Listings and Streamline Accepted Candidate Applications</p>
                    </div>
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    currentJobs?.map(job => (
                                        ...
                                        >
                                            <td className="px-4 py-3" onClick={() => navigate(`/company-dashboard/Job-listing/${job._id}?isApplied=true`)}>
