    ...
    <div className="min-h-screen bg-white font-sans">
      <div className="max-w-7xl mx-auto p-4 bg-white">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-10 mb-4 gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Accepted Pool-Campus Drives</h1>
            <p className="text-gray-600 mt-2">Track Your Accepted Pool-Campus Drives</p>
          </div>
        </div>
            ...
            <table className="w-full text-left text-gray-700">
              ...
              <tbody>
                {loading ? (
                  ...
                  currentJobs.map(job => (
                    <tr key={job._id} className="border-b border-gray-200 hover:bg-gray-50" onClick={() => navigate(`/company-dashboard/preview/Pool-campus/${job._id}?isApplied=true`)}>
