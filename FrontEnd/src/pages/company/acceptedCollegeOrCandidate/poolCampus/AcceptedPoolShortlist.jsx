...
import ShortlistDrive from '@/components/company/acceptedCollegeOrCandidate/poolCampus/ShortlistDrive';
import { getAcceptedCandidateByCompany } from '@/lib/Company_AxiosInstance';

const AcceptedPoolShortlist = () => {
  ...
  const loadDrives = async () => {
    try {
      ...
      const response = await getAcceptedCandidateByCompany("college", "Pool-campus");
      console.log("Pool: ", response.data.response)
...
export default AcceptedPoolShortlist;
