        ...
        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg p-6">
          ...
          {applications.length === 0 ? (
            <div className="bg-gradient-to-r from-gray-50 to-white border border-gray-200 rounded-xl p-12 text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-green-100 to-green-50 mb-4">
                <CheckCircle className="h-8 w-8 text-green-400" />
              </div>
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Accepted Candidates</h3>
                ...
                <div key={applicant._id} className="bg-gradient-to-r from-gray-50 to-white border border-gray-100 rounded-xl p-6 hover:shadow-lg transition-all duration-200">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                    <div className="flex items-start gap-4 mb-4 md:mb-0">
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <span className="px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-green-100 to-green-50 text-green-700 border border-green-200">
                            Accepted
                          </span>
                        </div>
                        <div className="flex flex-wrap items-center gap-3 mt-2">
                    ...
                    <div className="text-sm text-gray-600">
                      Accepted on: {new Date(applicant?.updatedAt || applicant?.createdAt).toLocaleDateString()}
                    </div>
                  </div>

                  {/* Applicant Details */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    {/* Left Column - Contact & Salary Info */}
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {applicant?.applicant.skills?.slice(0, 6).map((skill, index) => (
                            <span 
                              key={index} 
                  ...
                  <div className="flex flex-wrap gap-3 pt-6 border-t border-gray-200">
                    ...
                    <button
                      ...
                      disabled={isSubmitting}
                      className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-red-100 to-red-50 border border-red-200 text-red-700 rounded-xl hover:bg-red-50 hover:border-red-300 transition-all duration-200 disabled:opacity-50"
                    >
                      <XCircle size={16} />
                      Reject Application
                    </button>
