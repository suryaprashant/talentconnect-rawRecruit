  ...
  const getApplicants = async (targetVisited) => {
    ...
    try {
      ...
      if (targetVisited === false) {
        response = await getApplicationsForJob(jobId, jobType, "Accepted", targetVisited);
      } else {
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  Accepted Applications for: {job?.jobTitle || job?.jobRoles?.[0] || 'Internship Position'}
                </h1>
        ...
        {applications.length === 0 ? (
          <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No accepted candidates found</h3>
