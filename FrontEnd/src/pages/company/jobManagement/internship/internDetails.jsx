...
// Update the ResumeViewerModal component at the top of InternshipDetails.js
...
const InternshipDetails = ({ job, isVisited, onClose }) => {
  ...
  // Handle resume viewing - opens in new tab
            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  Applicants for: {job?.jobTitle || job?.jobRoles?.[0] || 'Internship Position'}
                </h1>
