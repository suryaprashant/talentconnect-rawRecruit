...
const HiringPreferencesStep = ({ formData, handleChange, nextStep, prevStep }) => {
    // If formData.lookingFor comes in as an array ['internship', 'job'], we set local state to 'both' for UI purposes
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        // Ensure that if local state is 'both', we submit the array ['internship', 'job']
        const valueToSend = lookingFor === 'both' ? ['internship', 'job'] : [lookingFor];
    ...
    const handleLookingForClick = (value) => {
        setLookingFor(value)
        // If 'both' is selected, send ['internship', 'job'], otherwise send [value]
        const newValue = value === 'both' ? ['internship', 'job'] : [value];
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                <div ref={locationsRef}>
                                    ...
                                    <div className="relative">
                                        <div
                                            className="flex items-center justify-between p-3 border border-gray-200 rounded-xl cursor-pointer hover:border-[#667eea]/50 transition-all duration-300 bg-white"
                                            onClick={() => setShowLocationsDropdown(!showLocationsDropdown)}
                                        >
                                            <span className="text-gray-700">Select Locations</span>
                                            <ChevronDownIcon
                                        ...
                                        {showLocationsDropdown && (
                                            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg">
                                                <div className="max-h-52 overflow-auto rounded-xl">
