...
// export default function OffCampusListingPage() {
                    ...
                    {filteredCandidates.map(candidate => (
                        <div key={candidate._id} className="border rounded-lg p-6 shadow-sm">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    className={`
                                        flex-1 py-2 rounded flex items-center justify-center text-white 
                                        ${candidate.status === 'Interview Scheduled' ? 'bg-gray-800' : 'bg-black hover:bg-gray-800'}
                                    `}
                                    onClick={() => handleSchedule(candidate)}
                                >
                                    <Calendar size={16} className="mr-1" />
