      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-xl shadow p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* First Row: Venue and College Type */}
...
{/* Eleventh Row: Hiring Timeline Dates */}
<div>
    ...
    <div>
      ...
      <div className="relative">
        ...
        <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={14} />
            ...
            {/* Twelfth Row: Rounds and Selection Process */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Number of Rounds */}
              <div>
            ...
            {/* Thirteenth Row: Contact Person and Designation */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Contact Person */}
              <div>
            ...
            {/* Fourteenth Row: Contact Email and Mobile */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Fifteenth Row: LinkedIn and Minimum Students */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
