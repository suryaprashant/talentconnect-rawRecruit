...
//     'Case Study',
//     'Presentation'
//   ].map(option => `${option}`).sort((a, b) => a.localeCompare(b));
...
//     jobRoles: false,
//     skills: false,
//     selectionProcess: false, // <-- Added for new multi-select
//     amenities: false,
//     benefits: false
//   });
...
//   const selectionProcessRef = useRef(null); // <-- Added ref
...
//       }
//       // Added check for selectionProcess dropdown
//       if (selectionProcessRef.current && !selectionProcessRef.current.contains(event.target)) {
//         setDropdownOpen(prev => ({ ...prev, selectionProcess: false }));
//       }
...
//       jobRoles: false,
//       skills: false,
//       selectionProcess: false, // Reset others when one is opened
//       amenities: false,
//       benefits: false,
...
//         selectionProcess: formData.selectionProcess.join(' + '), // Joining the array into a string
//         contactPerson: {
