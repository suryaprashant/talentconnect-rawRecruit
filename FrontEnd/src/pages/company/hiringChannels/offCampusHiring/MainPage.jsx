      ...
      <div className="container mx-auto px-4 max-w-6xl flex flex-col py-4">
        ...
        <header className="mb-8 pt-2">
          ...
          <p className="text-center text-sm text-gray-600 mt-4 max-w-xl mx-auto">
            Reach skilled graduates and job seekers beyond campus boundaries.
            OffCampus Access enables flexible, skill-first hiring with targeted
            campaigns, internships, and role-based outreach.
          </p>
        </header>
