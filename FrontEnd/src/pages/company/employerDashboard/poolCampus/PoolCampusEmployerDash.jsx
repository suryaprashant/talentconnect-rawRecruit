...
const PoolCampusEmployeeDash = () => {
    ...
    // UPDATED: Handle message officer click - using only email from Auth table
        ...
        try {
            ...
            if (response.data) {
                ...
                const conversationUser = {
                    _id: collegeUserId,
                    name: collegeDetails?.collegeUniversityDetails?.collegeName || 'College',
                    ...
                    userType: 'college',
                    fullname: collegeDetails?.collegeUniversityDetails?.collegeName || 'College'
                };
