            ...
            <div className="grid md:grid-cols-12 gap-4 p-6">
              ...
              <div className="md:col-span-9">
                <div className="space-y-4">
                  ...
                  {renderInputField('companyDetails', 'companyLocation', 'Company Location', 'select', 'Select Location', locationOptions, true)}
                  <div className="grid grid-cols-2 gap-4">
                    {renderInputField('companyDetails', 'state', 'State', 'select', 'Select State', locationOptions)}
                    {renderInputField('companyDetails', 'city', 'City', 'select', 'Select City', locationOptions)}
                    {renderInputField('companyDetails', 'country', 'Country', 'select', 'Select Country', locationOptions)}
                    {renderInputField('companyDetails', 'pincode', 'Pincode', 'text', 'Pincode')}
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-12 gap-4 p-6">
              ...
              <div className="md:col-span-9">
                <div className="space-y-4">
                  ...
                  <div>
                    {renderInputField('hiringPreferences', 'hiringLocations', 'Preferred Hiring Locations', 'custom-multiselect', 'Select locations...', locationOptions)}
                     {isEditing && (
                      <div className="flex items-center gap-2 mt-2">
