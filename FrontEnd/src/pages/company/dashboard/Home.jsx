  ...
  >
    ...
    <div className="relative z-10 flex flex-col flex-grow">
      ...
      <div className="grid grid-cols-2 gap-1.5 mt-auto">
        ...
        {/* <div className="text-center">
          <div className="text-sm font-bold text-[#7c3aed]">{dashboardData.totalShortlisted}</div>
          <div className="text-[10px] text-gray-500 truncate">Shortlisted</div>
        </div>
        <div className="text-center">
          <div className="text-sm font-bold text-[#6d28d9]">{dashboardData.totalAccepted}</div>
          <div className="text-[10px] text-gray-500 truncate">Accepted</div>
        </div> */}
        <div className="text-center">
          <div className="text-sm font-bold text-[#5b21b6]">{dashboardData.totalRejected}</div>
