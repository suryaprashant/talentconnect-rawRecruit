  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#667eea]/10 via-[#f093fb]/5 to-[#764ba2]/10">
      <div className="container mx-auto px-4 py-8 pt-20">
        ...
        {/* Key Metrics Cards */}
<div className="grid grid-cols-1 md:grid-cols-3 auto-rows-fr gap-4 mb-8">
  {/* On-Campus Applications Card */}
  <div
    className="group relative overflow-hidden bg-white border border-gray-200 rounded-xl shadow-lg p-4 cursor-pointer hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col h-full min-h-[180px]"
  ...
  >
    ...
    {/* Hover */}
    <div className="absolute inset-0 bg-gradient-to-br from-[#9333ea]/5 via-transparent to-[#7c3aed]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

    <div className="relative z-10 flex flex-col flex-grow">
      <div className="flex items-center justify-between mb-3">
        <div className="p-2 bg-gradient-to-br from-[#9333ea]/10 to-[#7c3aed]/10 rounded-lg border border-[#9333ea]/20">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#9333ea" className="w-5 h-5">
            <path fillRule="evenodd" d="M11.54 22.351l.07.04.028.016a.76.76 0 00.723 0l.028-.015.071-.041a16.975 16.975 0 001.144-.742 19.58 19.58 0 002.683-2.282c1.944-1.99 3.963-4.98 3.963-8.827a8.25 8.25 0 00-16.5 0c0 3.846 2.02 6.837 3.963 8.827a19.58 19.58 0 002.682 2.282 16.975 16.975 0 001.145.742zM12 13.5a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
          </svg>
        </div>
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-gradient-to-r from-[#9333ea]/10 to-[#7c3aed]/10 text-[#9333ea] border border-[#9333ea]/20">
          ON-CAMPUS
        </span>
      </div>

      <h3 className="text-sm font-bold text-gray-900 mb-1">On-Campus</h3>
      <div className="flex items-baseline space-x-1 mb-2 flex-grow">
        <p className="text-2xl font-bold text-[#9333ea]">{dashboardData.appliedByCategory['On-campus']}</p>
        <span className="text-xs text-gray-500">candidates</span>
      </div>

      <div className="flex items-center justify-between text-xs mt-auto">
        <span className="text-gray-600">View details</span>
        <div className="p-1.5 bg-gradient-to-r from-[#9333ea] to-[#7c3aed] rounded-full group-hover:translate-x-0.5 transition-transform duration-200">
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[#7c3aed]/5 via-transparent to-[#6d28d9]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

    <div className="relative z-10 flex flex-col flex-grow">
      <div className="flex items-center justify-between mb-3">
        <div className="p-2 bg-gradient-to-br from-[#7c3aed]/10 to-[#6d28d9]/10 rounded-lg border border-[#7c3aed]/20">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#7c3aed" className="w-5 h-5">
            <path d="M4.5 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM14.25 8.625a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0zM1.5 19.125a7.125 7.125 0 0114.25 0v.003l-.001.119a.75.75 0 01-.363.63 13.067 13.067 0 01-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 01-.364-.63l-.001-.122zM17.25 19.128l-.001.144a2.25 2.25 0 01-.233.96 10.088 10.088 0 005.06-1.01.75.75 0 00.42-.643 4.875 4.875 0 00-6.957-4.611 8.586 8.586 0 011.71 5.157v.003z" />
          </svg>
        </div>
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-gradient-to-r from-[#7c3aed]/10 to-[#6d28d9]/10 text-[#7c3aed] border border-[#7c3aed]/20">
          POOL-CAMPUS
        </span>
      </div>
      ...
      <div className="flex items-baseline space-x-1 mb-2 flex-grow">
        <p className="text-2xl font-bold text-[#7c3aed]">{dashboardData.appliedByCategory['Pool-campus']}</p>
        <span className="text-xs text-gray-500">candidates</span>
      </div>

      <div className="flex items-center justify-between text-xs mt-auto">
        <span className="text-gray-600">View details</span>
        <div className="p-1.5 bg-gradient-to-r from-[#7c3aed] to-[#6d28d9] rounded-full group-hover:translate-x-0.5 transition-transform duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
            <path fillRule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clipRule="evenodd" />
          </svg>
        </div>
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[#6d28d9]/5 via-transparent to-[#5b21b6]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

    <div className="relative z-10 flex flex-col flex-grow">
      <div className="flex items-center justify-between mb-3">
        <div className="p-2 bg-gradient-to-br from-[#6d28d9]/10 to-[#5b21b6]/10 rounded-lg border border-[#6d28d9]/20">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#6d28d9" className="w-5 h-5">
        ...
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-gradient-to-r from-[#6d28d9]/10 to-[#5b21b6]/10 text-[#6d28b6] border border-[#6d28d9]/20">
          OFF-CAMPUS
        </span>
      </div>
      ...
      <div className="flex items-baseline space-x-1 mb-2 flex-grow">
        <p className="text-2xl font-bold text-[#6d28d9]">{dashboardData.appliedByCategory['Off-campus']}</p>
        <span className="text-xs text-gray-500">candidates</span>
      </div>

      <div className="flex items-center justify-between text-xs mt-auto">
        <span className="text-gray-600">View details</span>
        <div className="p-1.5 bg-gradient-to-r from-[#6d28d9] to-[#5b21b6] rounded-full group-hover:translate-x-0.5 transition-transform duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
            <path fillRule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clipRule="evenodd" />
          </svg>
        </div>
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[#5b21b6]/5 via-transparent to-[#4c1d95]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

    <div className="relative z-10 flex flex-col flex-grow">
      <div className="flex items-center justify-between mb-3">
        <div className="p-2 bg-gradient-to-br from-[#5b21b6]/10 to-[#4c1d95]/10 rounded-lg border border-[#5b21b6]/20">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#5b21b6" className="w-5 h-5">
            <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd" />
          </svg>
        </div>
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-gradient-to-r from-[#5b21b6]/10 to-[#4c1d95]/10 text-[#5b21b6] border border-[#5b21b6]/20">
          STATUS
        </span>
      </div>
      ...
      <div className="space-y-2 mb-2 flex-grow">
        <div className="flex items-center justify-between">
          ...
          <span className="font-bold text-[#9333ea]">{dashboardData.totalApplied}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-600">Shortlisted</span>
          <span className="font-bold text-[#7c3aed]">{dashboardData.totalShortlisted}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-600">Accepted</span>
          <span className="font-bold text-[#6d28d9]">{dashboardData.totalAccepted}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-xs text-gray-600">Rejected</span>
          <span className="font-bold text-[#5b21b6]">{dashboardData.totalRejected}</span>
        </div>
      </div>

      <div className="flex items-center justify-between text-xs mt-auto">
        <span className="text-gray-600">View analytics</span>
        <div className="p-1.5 bg-gradient-to-r from-[#5b21b6] to-[#4c1d95] rounded-full group-hover:translate-x-0.5 transition-transform duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
            <path fillRule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clipRule="evenodd" />
          </svg>
        </div>
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[#4c1d95]/5 via-transparent to-[#3b0764]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

    <div className="relative z-10 flex flex-col flex-grow">
      <div className="flex items-center justify-between mb-3">
        <div className="p-2 bg-gradient-to-br from-[#4c1d95]/10 to-[#3b0764]/10 rounded-lg border border-[#4c1d95]/20">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#4c1d95" className="w-5 h-5">
        ...
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-gradient-to-r from-[#4c1d95]/10 to-[#3b0764]/10 text-[#4c1d95] border border-[#4c1d95]/20">
          SHORTLISTED
        </span>
      </div>
      ...
      <div className="flex items-baseline space-x-1 mb-2 flex-grow">
        <p className="text-2xl font-bold text-[#4c1d95]">{dashboardData.totalShortlisted}</p>
        <span className="text-xs text-gray-500">candidates</span>
      </div>

      <div className="flex items-center text-xs mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 mr-1 text-[#4c1d95]">
          <path fillRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zM12.75 6a.75.75 0 00-1.5 0v6a.75.75 0 001.5 0V6zm-1.5 9.75a.75.75 0 111.5 0 .75.75 0 01-1.5 0z" clipRule="evenodd" />
        </svg>
      ...
      <div className="flex items-center justify-between text-xs mt-auto">
        <span className="text-gray-600">View details</span>
        <div className="p-1.5 bg-gradient-to-r from-[#4c1d95] to-[#3b0764] rounded-full group-hover:translate-x-0.5 transition-transform duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
            <path fillRule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clipRule="evenodd" />
          </svg>
        </div>
  ...
  >
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-[#3b0764]/5 via-transparent to-[#2d044e]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

    <div className="relative z-10 flex flex-col flex-grow">
      <div className="flex items-center justify-between mb-3">
        <div className="p-2 bg-gradient-to-br from-[#3b0764]/10 to-[#2d044e]/10 rounded-lg border border-[#3b0764]/20">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3b0764" className="w-5 h-5">
            <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd" />
          </svg>
        </div>
        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-gradient-to-r from-[#3b0764]/10 to-[#2d044e]/10 text-[#3b0764] border border-[#3b0764]/20">
          ACCEPTED
        </span>
      </div>
      ...
      <div className="flex items-baseline space-x-1 mb-2 flex-grow">
        <p className="text-2xl font-bold text-[#3b0764]">{dashboardData.totalAccepted}</p>
        <span className="text-xs text-gray-500">candidates</span>
      </div>

      <div className="flex items-center text-xs mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 mr-1 text-[#3b0764]">
          <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.14-.094l3.75-5.25z" clipRule="evenodd" />
        </svg>
      ...
      <div className="flex items-center justify-between text-xs mt-auto">
        <span className="text-gray-600">View details</span>
        <div className="p-1.5 bg-gradient-to-r from-[#3b0764] to-[#2d044e] rounded-full group-hover:translate-x-0.5 transition-transform duration-200">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3">
            <path fillRule="evenodd" d="M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z" clipRule="evenodd" />
          </svg>
        </div>
