        ...
        <div className="grid md:grid-cols-2 border-b">
          ...
          <div className="p-6">
            <div className="grid grid-cols-3 gap-2 text-sm">
              ...
              <div className="col-span-2">{profileData.companyDetails.collegeWebsite || '-'}</div>
              ...
              <div className="col-span-2">{profileData.userId.email || '-'}</div>
              ...
              <div className="col-span-2">{profileData.companyDetails.country || '-'}</div>

              <div className="font-medium">State:</div>
              <div className="col-span-2">{profileData.companyDetails.state || '-'}</div>

              
              <div className="font-medium">City:</div>
              <div className="col-span-2">{profileData.companyDetails.city || '-'}</div>
