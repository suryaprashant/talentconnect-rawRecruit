  ...
  const roles = [
    {
      ...
      gradient: 'from-[#143694] to-[#1e4ed8]',
          ...
          <div className="max-w-7xl mx-auto w-full">
            ...
            <div className="relative mb-12 mt-12">
              ...
              <div className="flex justify-center">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#143694] to-[#1e4ed8] text-white px-5 py-2 rounded-full text-sm font-semibold shadow-md">
                  {/* Sparkles Icon */}
            ...
            <div className="text-center mb-12">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                Get Started with <span className="text-[#143694]">TalentConnect</span>
              </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-8 max-w-7xl mx-auto">
              {roles.map((role) => (
                <div
                  ...
                  className={`
                    ...
                    ${selectedRole === role.key
                      ? 'ring-2 ring-offset-2 ring-[#143694] transform scale-[1.02]'
                ...
                >
                  ...
                  {/* Selection indicator */}
                  {selectedRole === role.key && (
                    <div className="absolute -top-2 -right-2 bg-[#143694] text-white p-1.5 rounded-full shadow-lg z-10">
                      {/* CheckCircle Icon */}
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100 mt-auto">
                    <span className={`font-medium text-xs transition-all duration-300 ${selectedRole === role.key
                        ? 'text-[#143694]'
                        : 'text-gray-500 group-hover:text-[#143694]'
                      }`}>
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className={`w-4 h-4 transition-transform duration-300 ${hoveredRole === role.key ? 'translate-x-1 text-[#143694]' : 'text-gray-400'
                        }`}
                    >
            ...
            <div className="text-center">
              <button
                ...
                className={`
                  group bg-gradient-to-r from-[#143694] to-[#1e4ed8] text-white 
