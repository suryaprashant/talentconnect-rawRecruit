        ...
        <>
            <div className="bg-white p-6 rounded-lg shadow-sm mb-6 border border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-6">
                    ...
                    >
                        {currentStatus === 'Accepted' ? 'Already Accepted' : (isSubmitting ? 'Processing...' : 'Accept College')}
                    </button>
                    <button 
                    ...
                    >
                        {currentStatus === 'Rejected' ? 'Already Rejected' : (isSubmitting ? 'Processing...' : 'Reject College')}
                    </button>
                    <button 
