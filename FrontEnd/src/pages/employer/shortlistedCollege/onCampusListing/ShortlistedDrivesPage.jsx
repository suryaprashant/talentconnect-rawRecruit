    ...
    <div className="min-h-screen bg-white font-sans">
      <div className="max-w-7xl mx-auto p-4 bg-white">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-10 mb-4 gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Shortlisted On-Campus Drives</h1>
            <p className="text-gray-600 mt-2">Track Your Shortlisted On-Campus Drives and College Applications</p>
          </div>
        </div>
