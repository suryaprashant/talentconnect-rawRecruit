...
import CollegeRequestDetail from './DriveDetailPage';
...
export default function OnCampusJobManagement() {
  ...
  const fetchJobs = async () => {
    ...
    setError(null);
    try {
      const response = await getPostedJobs("On-campus", "Shortlisted");
  ...
  const fetchCollegesForJob = async (jobId, jobType) => {
    ...
    setError(null);
    try {
      const response = await getCollegeApplicationsForJob(jobId, jobType, "Shortlisted");
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600">Track Your Shortlisted On-Campus Drives and College Applications</p>
            </div>
          </div>
        </div>

        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg overflow-hidden">
          <div className="p-4 border-b border-gray-100 flex flex-col md:flex-row items-center gap-4 bg-gradient-to-r from-gray-50 to-white">
          ...
          {error && (
            <div className="p-4 bg-gradient-to-r from-red-50 to-white border border-red-200 rounded-xl m-4">
              <div className="flex items-start">
                <AlertCircle className="h-5 w-5 text-red-600 mr-3 mt-0.5" />
                <div>
                  <h3 className="text-sm font-medium text-red-800">Error</h3>
            ...
            <div className="min-w-full">
              ...
              <div className="divide-y divide-gray-100">
                {loading ? (
                  ...
                  currentJobs.map(job => (
                    <div key={job._id} className="px-4 py-4 hover:bg-gray-50/50 transition-all duration-200">
                      <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-3 capitalize">
                          <div className="flex items-center gap-2">
                            ...
                            <span>{displayWorkLocations(job)}</span>
                          </div>
                        </div>
                        ...
                        {/* Applications */}
                        <div className="col-span-2">
                          <span className="inline-flex items-center justify-center px-3 py-1.5 bg-gradient-to-r from-gray-100 to-white border border-gray-200 text-gray-700 rounded-full text-sm font-medium">
                        ...
                        <div className="col-span-2">
                          <div className="flex gap-2">
                            <button
                              ...
                              className="p-2 bg-gradient-to-r from-gray-100 to-white border border-gray-200 text-gray-500 rounded-lg hover:bg-gray-50 hover:text-[#667eea] hover:border-[#667eea]/50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
