...
import CollegeRequestDetail from './PoolCampusDetailPage';
        ...
        <div className="max-w-4xl mx-auto p-4">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 capitalize">
              {displayWorkLocations(selectedJob)} • {Array.isArray(selectedJob.employmentType) ? selectedJob.employmentType.join(', ') : selectedJob.employmentType || 'N/A Type'}
            </p>
          </div>
