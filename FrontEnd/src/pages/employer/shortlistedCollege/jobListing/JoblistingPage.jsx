            ...
            <div className="max-w-7xl mx-auto p-4 py-8">
                        ...
                        <div className="mb-4 md:mb-0">
                            <div className="flex items-center mb-2">
                                ...
                                <h1 className="text-2xl font-bold bg-gradient-to-r from-[#143694] to-[#1e4ed8] bg-clip-text text-transparent">
                                    Shortlisted Job-listing Applications
                                </h1>
                            </div>
                ...
                <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                        ...
                        >
                            All Jobs <span className="inline-flex items-center justify-center w-6 h-6 bg-gradient-to-r from-[#143694] to-[#1e4ed8] text-white rounded-full text-xs ml-1">{jobs?.length || 0}</span>
                        </button>
                    </div>
