...
import {
    ...
    Building2, MapPin, Calendar, Briefcase, AlertCircle, Users
} from 'lucide-react';
                        ...
                        <div className="mb-4 md:mb-0">
                            <div className="flex items-center mb-2">
                                ...
                                <h1 className="text-2xl font-bold bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent">
                                    Internship Shortlisted Applications
                                </h1>
                            </div>
                            <p className="text-gray-600">
                                Track Your Internship and Streamline Shortlisted Candidate Applications
                            </p>
                        </div>
                        ...
                        <div className="flex space-x-2">
                            {['All Jobs', 'Published', 'Drafts'].map((tab) => (
                                <button
                                    ...
                                    className={`inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-100 to-white border border-gray-200 text-gray-700 rounded-lg font-medium transition-all duration-200 ${
                                        activeTab === tab 
                                            ? 'border-[#667eea] text-[#667eea] bg-gradient-to-r from-[#667eea]/10 to-[#764ba2]/5' 
                                            : 'hover:bg-gray-50'
                                    }`}
                                >
                                    {tab} 
                                    {tab === 'All Jobs' && (
                                        <span className="inline-flex items-center justify-center w-6 h-6 bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white rounded-full text-xs ml-1">
                                            {jobs?.length || 0}
                                        </span>
                                    )}
                                </button>
