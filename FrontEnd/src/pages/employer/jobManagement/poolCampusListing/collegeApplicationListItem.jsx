...
const CollegeRequestDetail = ({ collegeApplication, driveDetails, onAccept, onShortlist, onReject }) => {
    ...
    const collegeCatogories = Array.isArray(driveDetails?.collegeCategories)
        ? driveDetails.collegeCategories.join(', ')
        : driveDetails?.collegeCategories || 'Not Specified'; 
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm mb-6 border border-gray-200">
                ...
                <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <DetailRow icon={ClipboardList} label="College Type" value={collegeCatogories} />
