...
export default function PoolCampusJobManagement() {
  ...
  const handleViewColleges = async (job) => {
    setSelectedJob(job);
    setIsVisited("false"); // view all applied
  ...
  const showNewApplication = async (job) => {
    try {
      setSelectedJob(job);
      setIsVisited("true"); // new (unvisited) applications
  ...
  const displayEmploymentTypes = (job) => {
    const employmentTypes = job.employmentType || [];
    if (!employmentTypes || employmentTypes.length === 0) return 'N/A';
    return Array.isArray(employmentTypes) ? employmentTypes.join(', ') : String(employmentTypes);
  };
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-2">
                    ...
                    <span className="inline-flex items-center text-sm text-gray-600 bg-gradient-to-r from-gray-50 to-white px-3 py-1.5 rounded-lg">
                      ...
                      {displayEmploymentTypes(selectedJob)}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-12 gap-4 items-center">
                    ...
                    <div className="col-span-3">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-sm text-gray-500">{displayEmploymentTypes(job)}</span>
                        </div>
                      </Link>
                    </div>
                    ...
                    <div className="col-span-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700 text-sm">
                          {job.endDate ? new Date(job.endDate).toLocaleDateString('en-IN') : 'N/A'}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="col-span-2">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-file-search-corner-icon">
