    ...
    <div>
        ...
        <div className="relative">
            <select
                ...
                value={value || ''}
                onChange={onChange}
                className={`appearance-none w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#667eea]/30 focus:border-[#667eea] transition-all duration-300 bg-white/80 ${
                        ...
                        <div>
                            ...
                            {isRegisteringNewCompany ? (
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#667eea]/30 focus:border-[#667eea] transition-all duration-300 bg-white/80 ${
                            ...
                            <button
                                ...
                                className="text-[#667eea] text-sm font-medium mt-1 hover:text-[#764ba2] hover:underline transition-colors"
                            >
