      ...
      <div className="container mx-auto px-4 max-w-6xl flex flex-col py-4">
        ...
        <header className="mb-8 pt-2">
          ...
          <p className="text-center text-sm text-gray-600 mt-4 max-w-xl mx-auto">
            Tap into diverse talent from multiple institutions through one powerful drive. Pool Campus Connect brings students from several colleges together, enabling centralized hiring drives that are time-saving, cost-efficient, and great for brand visibility.
          </p>
        </header>
