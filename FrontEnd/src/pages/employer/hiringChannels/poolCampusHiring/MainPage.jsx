...
const serviceData = [
  ...
  },
  {
    ...
    icon: "/images/efficiency-icon.png"
  },
  {
    id: 3,
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent mb-4">
            Pool Campus Connect: <br /> Hire Bigger
          </h1>
          <p className="text-md text-gray-600 max-w-2xl mx-auto">
            ...
            for companies to conduct centralized hiring drives that are time-saving, 
            cost-efficient, and great for brand visibility.
          </p>
        </header>
