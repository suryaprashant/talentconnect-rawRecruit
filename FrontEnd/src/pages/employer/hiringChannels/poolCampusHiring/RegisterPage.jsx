      ...
      <div className="container mx-auto px-4 py-10 max-w-2xl">
        ...
        <header className="mb-6 pt-2 text-center">
          ...
          <p className="text-sm text-gray-600 mt-3 max-w-xl mx-auto">
            Tap into diverse talent from multiple institutions through one
            powerful drive. Pool Campus Connect brings students from several
            colleges together, making it easier for companies to conduct
            centralized hiring drives.
          </p>
        </header>
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-lg p-6">
          ...
          <p className="text-gray-600 mb-6 text-center">
            Fill in your details to get more information about our Pool-Campus
            hiring services
          </p>
