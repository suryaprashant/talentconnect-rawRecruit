import { Users, Calendar, Clock, MessageSquare, ArrowLeft } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-8 max-w-2xl">
          ...
          <header className="mb-12 text-center">
            ...
            <p className="text-md text-gray-600 max-w-2xl mx-auto">
              ...
              Pool Campus Connect brings students from several colleges together, making it easier for companies 
              to conduct centralized hiring drives that are time-saving, cost-efficient, and great for brand visibility.
            </p>
          </header>
