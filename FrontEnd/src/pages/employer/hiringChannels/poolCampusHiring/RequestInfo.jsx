...
const handleAddNewSkill = async (newSkillName) => {
  ...
  try {
    ...
    // Update global list and form state
...
const handleSelectOrAddSkill = async (skillName) => {
  ...
  const [formData, setFormData] = useState(() => {
    const savedData = localStorage.getItem('pendingEmployerPoolHiring');
    ...
    try {
      ...
      console.error("Error parsing saved Employer Pool Campus data:", e);
      return initialState;
    }
  });
  useEffect(() => {
  ...
  {isSkillDropdownOpen && (
    <div className="absolute z-50 w-full mt-2 bg-white border border-gray-100 rounded-xl shadow-2xl overflow-hidden animate-in slide-in-from-top-2 duration-200">
      <div className="max-h-64 overflow-y-auto">
        ...
        {/* 2. Show "Add New" button if no exact match exists */}
        ...
        {customSkillSearch === "" && filteredSkillOptions.length === 0 && (
          <div className="px-5 py-8 text-center text-gray-400 text-xs italic">
            Start typing to browse the skills database...
          </div>
        )}
      </div>
    </div>
            ...
            <div className="pt-4 border-t border-gray-100">
              ...
              <div className="space-y-6">
                ...
                {/* Online Test Date and Interview Window */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Online Test Date */}
                  <div className="relative">
                ...
                {/* Offer Rollout Date and Number of Rounds */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Offer Rollout Date */}
                  <div className="relative">
