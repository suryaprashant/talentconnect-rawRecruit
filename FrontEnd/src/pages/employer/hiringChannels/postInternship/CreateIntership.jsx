...
import { ChevronDown, X, Briefcase, MapPin, DollarSign, Users, BookOpen, Target, Award, Shield, Clock, GraduationCap, Calendar, IndianRupee } from 'lucide-react';
...
export default function EmployerPostIntership() {
  ...
  {/*const jobTitleOptions = [
    ...
    "Frontend Developer", "Backend Developer", "Full Stack Developer", "Mobile App Developer", "Cloud Engineer",
    "Database Administrator", "Security Analyst", "Project Manager", "Scrum Master", "Technical Writer",
    "Data Scientist", "AI Engineer", "DevOps Specialist", "Site Reliability Engineer", "IT Support Specialist",
    "Cybersecurity Analyst", "Digital Marketing Specialist", "Content Writer", "Graphic Designer", "UI Designer",
    "UX Researcher", "Product Designer", "Business Intelligence Analyst", "Data Engineer", "Machine Learning Specialist",
    "AR/VR Developer", "Blockchain Developer", "Game Developer", "Embedded Systems Engineer", "Hardware Engineer",
    "Network Administrator", "Systems Engineer", "IT Manager", "Solutions Architect", "Technical Lead",
    "Engineering Manager", "CTO", "CIO"
  ];*/}
