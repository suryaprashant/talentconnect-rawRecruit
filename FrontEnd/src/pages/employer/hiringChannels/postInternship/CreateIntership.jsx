...
//     workMode: 'On-site',
//     location: '', // Changed to a single string for dropdown
//     minPackage: {
//       currency: 'USD',
//       amount: ''
//     },
...
//   const allLocations = ["New York, NY", "San Francisco, CA", "Austin, TX", "Chicago, IL", "Remote", "Other"];
...
//       }
//       if (certificationsDropdownRef.current && !certificationsDropdownRef.current.contains(event.target)) {
//         setDropdownOpen(prev => ({ ...prev, certifications: false }));
//       }
...
//       const payload = {
//         ...formData,
//         location: formData.location ? [formData.location] : [], // Convert single location to array for backend
//         minPackage: {
...
//       alert(`Error posting internship: ${error.response?.data?.error || error.response?.data?.message || error.message}`);
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
...
//           <p className="text-sm text-gray-600 mb-4">Provide the core details about this internship opportunity.</p>
...
//           <div className="mb-4">
//             <label htmlFor="jobTitle" className="block text-sm font-medium mb-2">Internship Title <span className="text-red-500">*</span></label>
//             <input type="text" id="jobTitle" name="jobTitle" placeholder="Enter the Internship Title" className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-black" value={formData.jobTitle} onChange={handleInputChange} />
//           </div>
...
//             <div className="relative">
//                 <select id="location" name="location" className="w-full p-2 border border-gray-300 rounded-md appearance-none bg-white pr-10 focus:ring-2 focus:ring-black" value={formData.location} onChange={handleInputChange}>
...
//           <div className="mb-4">
//             <label htmlFor="description" className="block text-sm font-medium mb-2">Internship Description <span className="text-red-500">*</span></label>
//             <textarea id="description" name="description" placeholder="Describe the internship responsibilities and requirements..." className="w-full p-2 border border-gray-300 rounded-md h-32 focus:ring-2 focus:ring-black" value={formData.description} onChange={handleInputChange}></textarea>
//           </div>
//         </div>
...
//             <textarea id="eligibilityCriteria" name="eligibilityCriteria" placeholder="e.g., Minimum 3.0 GPA, Must be currently enrolled in a degree program..." className="w-full p-2 border border-gray-300 rounded-md h-24 focus:ring-2 focus:ring-black" value={formData.eligibilityCriteria} onChange={handleInputChange}></textarea>
//           </div>
...
//             <div className="relative">
//               <select id="studentStreams" name="studentStreams" className="w-full p-2 border border-gray-300 rounded-md appearance-none bg-white pr-10 focus:ring-2 focus:ring-black" value={formData.studentStreams[0] || ''} onChange={(e) => setFormData(prev => ({...prev, studentStreams: e.target.value ? [e.target.value] : []}))}>
//                 <option value="">Select field of study</option>
//                 {fieldOfStudyOptions.map((option, index) => (<option key={index} value={option}>{option}</option>))}
//               </select>
//               <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} />
//             </div>
//           </div>
...
//                     <span>{skill}</span>
//                     <button type="button" className="ml-2 text-gray-500 hover:text-gray-800" onClick={(e) => { e.stopPropagation(); removeItem('skills', index); }}><X size={14}/></button>
//                   </div>
//                 ))}
//               </div>
...
//                   <div key={index} className="bg-gray-100 px-2 py-1 rounded-full flex items-center text-sm">
//                     <span>{benefit}</span>
//                     <button type="button" className="ml-2 text-gray-500 hover:text-gray-800" onClick={(e) => { e.stopPropagation(); removeItem('benefits', index); }}><X size={14}/></button>
//                   </div>
//                 ))}
//               </div>
...
//                   <div key={index} className="bg-gray-100 px-2 py-1 rounded-full flex items-center text-sm">
//                     <span>{cert}</span>
//                     <button type="button" className="ml-2 text-gray-500 hover:text-gray-800" onClick={(e) => { e.stopPropagation(); removeItem('certifications', index); }}><X size={14}/></button>
//                   </div>
//                 ))}
//               </div>
