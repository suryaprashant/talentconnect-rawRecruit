...
// You'll need to create or import your API functions for fresher dashboard
// import { getFresherDashboardMetrics } from '@/lib/Fresher_AxiosInstance'
    ...
    <div className="relative z-10 flex flex-col flex-grow">
      ...
      {/* <div className="mt-auto">
        <div className="text-center">
          <div className="text-xl font-bold text-[#4c1d95] mb-1">{dashboardData.byCategory['Off-campus']}</div>
