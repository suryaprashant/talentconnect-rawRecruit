...
export default function OnCampusApplication() {
                    ...
                    {selectedJob && (
                        <>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                                ...
                                <div className="mt-4">
                                    <Link to={`/college-dashboard/On-campus/${selectedJob?.jobDetails[0]?._id}?isApplied=true`} className="text-blue-500 text-sm font-medium">View full description</Link>
                                </div>
                            </div>
