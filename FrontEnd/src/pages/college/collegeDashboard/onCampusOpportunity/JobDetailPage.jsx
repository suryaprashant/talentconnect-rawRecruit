          ...
          <div className="bg-gradient-to-r from-[#143694]/5 to-[#1e4ed8]/5 px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                {/* <div 
                  className={`w-12 h-12 rounded-lg bg-gradient-to-br from-[#143694] to-[#1e4ed8] flex items-center justify-center text-white font-bold text-lg shadow-sm ${company.logo ? 'hidden' : ''}`}
                >
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                  <div className="flex items-center text-sm text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-[#143694]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  >
                    {companyLogo && !imageError ? (
                      <div className="relative">
                        ...
                        />
                        <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#143694] to-[#1e4ed8] hidden items-center justify-center text-white font-bold text-lg shadow-sm">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {/* <p className="text-sm text-gray-500 mt-1 flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1 text-[#143694] opacity-0 group-hover:opacity-100 transition-opacity" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="px-6 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
              <div>
                <div className="text-sm font-medium text-[#143694]">Looking For</div>
              ...
              <div>
                <div className="text-sm font-medium text-[#143694]">Amenities/Facilities Required</div>
          ...
          <div className="px-6 py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 mb-6">
              <div>
                <div className="text-sm font-medium text-[#143694]">Eligible Degrees</div>
                <div className="mt-1 text-base text-gray-900">{job?.degree?.join(' / ') || 'Not Specified'}</div>
              </div>
              <div>
                <div className="text-sm font-medium text-[#143694]">Eligible Streams</div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  {job?.contactPerson?.linkedin && (
                    <a href={job.contactPerson.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center mt-1 text-[#143694] hover:text-[#1e4ed8] transition-colors">
