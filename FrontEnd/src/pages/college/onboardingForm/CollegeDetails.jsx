              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full p-4 bg-white/70 backdrop-blur-sm border border-gray-200/80 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#143694] focus:border-transparent transition-all duration-200 text-lg disabled:opacity-50 disabled:cursor-not-allowed"
