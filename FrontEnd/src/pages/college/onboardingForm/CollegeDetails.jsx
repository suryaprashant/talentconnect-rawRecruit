...
export default function CollegeDetails({ formData, updateFormData, nextStep, prevStep }) {
    ...
    const [collegeDropdownMessage, setCollegeDropdownMessage] = useState('Select an existing college');
                        ...
                        <div>
                            ...
                            {!isRegisteringNewCollege ? (
                                <div>
                                    ...
                                    >
                                        <option value="">
                                            {existingColleges.length === 0 ? collegeDropdownMessage : 'Select an existing college'}
                                        </option>
                                ...
                                <div>
                                    ...
                                    >
                                        <span className='text-blue-600'>Select Existing College</span>
                                    </p>
                                </div>
                            )}
                        </div>
