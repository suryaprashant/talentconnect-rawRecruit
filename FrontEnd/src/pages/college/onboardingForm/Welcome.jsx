      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg shadow-blue-50/50 p-8 w-full max-w-lg text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            ...
            <button
              onClick={nextStep}
              className="px-8 py-3 bg-gradient-to-r from-[#93c5fd] to-[#3b82f6] text-white rounded-xl hover:shadow-lg hover:shadow-[#93c5fd]/40 transition-all duration-200 font-medium"
            >
              Next
            </button>
          </div>
