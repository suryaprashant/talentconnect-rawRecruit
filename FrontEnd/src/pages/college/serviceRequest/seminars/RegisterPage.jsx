      ...
      <div className="relative z-10 container mx-auto px-4 pt-14 max-w-2xl">
        ...
        <header className="mb-6 text-center">
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-xl mx-auto mt-3">
            Equip students with insights and knowledge that shape their careers. Our seminars bring industry experts to your campus, offering students a deeper understanding of various career paths, market trends, and essential skills.
          </p>
        </header>
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg p-6">
          <h2 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-[#1e4ed8] to-[#1e40af] bg-clip-text text-transparent text-center mb-1">
            Request for Transformative Seminars
          </h2>
