      ...
      <div className="relative z-10 container mx-auto px-4 pt-14 max-w-2xl">
        ...
        <header className="mb-6 text-center">
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-xl mx-auto mt-3">
            Equip students with insights and knowledge that shape their careers.
            Our seminars bring industry experts to your campus, offering
            students a deeper understanding of various career paths, market
            trends, and essential skills.
          </p>
        </header>
