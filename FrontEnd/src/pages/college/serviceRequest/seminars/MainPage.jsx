...
import { Lightbulb, TrendingUp, Users, Sparkles, ArrowRight, Info, FileText } from 'lucide-react';
...
const serviceData = [
  {
    ...
    color: "blue",
    iconElement: <Lightbulb className="w-6 h-6" />
  },
  {
    id: 2,
