...
const serviceData = [
  {
    ...
    description: "Host expert-led webinars, workshops, and campus talks that expose students to real-world industry trends and career pathways.",
    icon: <Lightbulb className="h-6 w-6 text-[#3b82f6]" />
  },
  {
    id: 2,
    title: "Skill Development",
    description: "Help students build practical and future-ready skills through structured learning sessions and hands-on guidance.",
    icon: <TrendingUp className="h-6 w-6 text-[#3b82f6]" />
  },
  {
    id: 3,
    title: "Networking Opportunities",
    description: "Enable students to connect with professionals, mentors, and peers, expanding their career network and opportunities.",
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-6xl flex flex-col py-4">
        ...
        <header className="mb-8 pt-2 text-center">
          ...
          <p className="text-sm text-gray-600 mt-4 max-w-xl mx-auto">
            Equip students with career-defining insights through expert-led seminars. Inspire informed decisions, broaden perspectives, and foster growth through impactful knowledge sharing.
          </p>
        </header>
        ...
        {/* CTA - Two buttons with swapped positions and correct redirection */}
