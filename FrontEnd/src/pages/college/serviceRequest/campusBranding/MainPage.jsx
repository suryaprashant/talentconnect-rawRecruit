      ...
      <div className="relative z-10 container mx-auto px-4 pt-16 max-w-6xl">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Attract, engage and retain top talent right from the source.
            Campus Branding helps your company build long-term relationships
            with students and establish early brand recall among future leaders.
          </p>
        </header>
