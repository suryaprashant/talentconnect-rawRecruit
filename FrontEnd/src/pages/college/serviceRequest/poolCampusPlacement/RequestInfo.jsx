...
export default function PoolCampusHiringForm({ onBackClick }) {
    ...
    const validateForm = () => {
        ...
        // Validate minimum students to be placed
                ...
                <div className="bg-white/90 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg shadow-blue-50/50 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div ref={degreeRef}>
                            ...
                            <div className="relative">
                                <div
                                    className={`w-full bg-white/50 backdrop-blur-sm border ${errors.degree ? 'border-red-300' : 'border-white/50'} rounded-xl p-3 min-h-[48px] cursor-pointer hover:border-[#93c5fd] transition-all duration-200`}
                                    onClick={() => setDropdownOpen(prev => ({ ...prev, degree: !prev.degree }))}
                                >
                                    {formData.degree.length > 0 ? (
                                        <div className="flex flex-wrap gap-2">
                        ...
                        <div ref={collegeTypesRef}>
                            ...
                            <div
                                onClick={() => setDropdownOpen(prev => ({ ...prev, collegeTypes: !prev.collegeTypes }))}
                                className={`w-full bg-white/50 backdrop-blur-sm border ${errors.collegeTypes ? 'border-red-300' : 'border-white/50'} rounded-xl p-3 min-h-[48px] cursor-pointer hover:border-[#93c5fd] transition-all duration-200 flex items-center justify-between`}
                            >
                                <span className={formData.collegeTypes ? "text-gray-900" : "text-gray-500"}>
                                    {formData.collegeTypes || 'Select college type'}
                                </span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    onChange={handleContactChange} 
                                    placeholder="Enter full name" 
                                    className={`w-full bg-white/50 backdrop-blur-sm border ${errors.contactPersonName ? 'border-red-300' : 'border-white/50'} rounded-xl px-3 py-3 focus:outline-none focus:ring-2 focus:ring-[#93c5fd] focus:border-transparent transition-all duration-200`}
                                    required 
                                />
                            ...
                            <div>
                                ...
                                <select 
                                    ...
                                    value={formData.contactPerson.designation} 
                                    onChange={handleContactChange} 
                                    className={`w-full bg-white/50 backdrop-blur-sm border ${errors.contactPersonDesignation ? 'border-red-300' : 'border-white/50'} rounded-xl px-3 py-3 focus:outline-none focus:ring-2 focus:ring-[#93c5fd] focus:border-transparent appearance-none transition-all duration-200`}
                                    required
                                >
                                    <option value="" disabled>Select designation</option>
                                    {designationOptions.map((designation) => (
                                ...
                                {errors.contactPersonDesignation && (
                                    <p className="mt-1 text-sm text-red-600">{errors.contactPersonDesignation}</p>
                                )}
                            </div>
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 flex items-center gap-2">
                                ...
                                <input 
                                    ...
                                    onChange={handleContactChange} 
                                    placeholder="example@company.com" 
                                    className={`w-full bg-white/50 backdrop-blur-sm border ${errors.contactPersonEmail ? 'border-red-300' : 'border-white/50'} rounded-xl px-3 py-3 focus:outline-none focus:ring-2 focus:ring-[#93c5fd] focus:border-transparent transition-all duration-200`}
                                    required 
                                />
                                {errors.contactPersonEmail && (
                                    <p className="mt-1 text-sm text-red-600">{errors.contactPersonEmail}</p>
                                )}
                            </div>
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 flex items-center gap-2">
                                ...
                                <input 
                                    ...
                                    onChange={handleContactChange} 
                                    placeholder="Enter 10-digit mobile number" 
                                    className={`w-full bg-white/50 backdrop-blur-sm border ${errors.contactPersonMobile ? 'border-red-300' : 'border-white/50'} rounded-xl px-3 py-3 focus:outline-none focus:ring-2 focus:ring-[#93c5fd] focus:border-transparent transition-all duration-200`}
                                    required 
                                />
                                {errors.contactPersonMobile && (
                                    <p className="mt-1 text-sm text-red-600">{errors.contactPersonMobile}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <select 
                                    id="minStudentsToBePlaced" 
                                    name="minStudentsToBePlaced" 
                                    className={`w-full bg-white/50 backdrop-blur-sm border ${errors.minStudentsToBePlaced ? 'border-red-300' : 'border-white/50'} rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-[#93c5fd] focus:border-transparent appearance-none transition-all duration-200`}
                                    value={formData.minStudentsToBePlaced} 
                                    onChange={handleChange} 
                                    required 
                                >
