            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  <button
                    type="button"
                    className="w-full bg-white/50 border border-white/50 rounded-xl p-3 text-left flex justify-between items-center focus:ring-2 focus:ring-[#93c5fd] outline-none"
                  ...
                  {isEmployeeDropdownOpen && (
                    <div className="absolute z-10 w-full mt-1 bg-white/90 backdrop-blur-sm border border-white/50 rounded-xl shadow-lg overflow-hidden">
                      {employeeOptions.map((option) => (
                        <div
                          key={option}
                          className="px-4 py-3 hover:bg-[#93c5fd]/10 cursor-pointer border-b border-white/50 last:border-b-0"
                          onClick={() => {
