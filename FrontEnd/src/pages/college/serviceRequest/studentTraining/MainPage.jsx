...
import { FileText, Users, TrendingUp, Sparkles, ArrowRight, Info, FileText as FileTextIcon } from 'lucide-react';

const serviceData = [
  {
    id: 1,
    title: "Resume Building",
    description: "Learn how to optimize your resume to showcase your unique skills, experience, and accomplishments. Our experts will provide personalized feedback to help you stand out to potential employers.",
    icon: "/images/custom-modules-icon.png",
    color: "blue",
    iconElement: <FileText className="w-6 h-6" />
  },
  {
    id: 2,
    title: "Interview Preparation",
    description: "Master the art of interviewing through interactive mock sessions and coaching on proven techniques. Gain the confidence to articulate your value and make a lasting impression.",
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 pt-20 max-w-6xl">
        ...
        <header className="mb-12 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            We offer targeted training programs to bridge skill gaps and ensure graduates are prepared with industry-specific skills necessary for their careers.
          </p>
        </header>
