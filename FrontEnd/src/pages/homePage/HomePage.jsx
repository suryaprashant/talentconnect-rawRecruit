...
>
  <div className="relative">
    ...
    <svg 
      ...
      viewBox="0 0 24 24" 
      fill="#667eea" 
      className="w-8 h-8 group-hover:rotate-12 transition-transform duration-500 animate-float1"
    >
    ...
    <svg 
      ...
      viewBox="0 0 24 24" 
      fill="#f5576c" 
      className="w-4 h-4 absolute -top-1 -right-1 group-hover:scale-110 transition-transform duration-500 animate-spin-slow"
    >
