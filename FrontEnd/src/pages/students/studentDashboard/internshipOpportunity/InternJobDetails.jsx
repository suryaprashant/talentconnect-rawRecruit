...
const InternJobDetails = () => {
  ...
  const handleApply = async () => {
    try {
      ...
      // console.log("Apply for internship response:", response.data.success);
        ...
        <main>
          <div className="bg-white p-8 rounded-xl shadow-md space-y-8">
            <header className="flex flex-col sm:flex-row items-start justify-between pb-4 border-b border-slate-200">
              <div>
                <h1 className="text-4xl font-medium text-slate-900 mb-2">{jobDetails.jobTitle}</h1>
                <p className="text-sm text-slate-600 mb-4">at {jobDetails.companyPosted?.companyDetails?.companyName}</p>
            ...
            <Section title="Opportunity Snapshot">
              <div className="flex flex-wrap gap-y-4 gap-x-8">
                ...
                <SnapshotListItem icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5 2a2 2 0 00-2 2v11a3 3 0 003 3h8a3 3 0 003-3V4a2 2 0 00-2-2H5zm0 2h10v9a1 1 0 01-1 1H6a1 1 0 01-1-1V4z" clipRule="evenodd" /></svg>} label="Certificate Required" value={jobDetails.certifications} />
