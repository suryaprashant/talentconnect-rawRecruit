...
function InternJobListings({ compact = false, onJobSelect, selectedJobId, hideSelected = false, onJobsLoaded }) {
      ...
      {isModalOpen && selectedJob && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="relative z-10 flex items-center justify-center h-full p-4">
            {/* You'll need to create an InternshipDetailModal component similar to OffCampusJobDetailModal */}
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedJob.stipend && (
                        <div className="flex items-center">
                          ...
                          <span>Stipend: ₹{selectedJob.stipend.toLocaleString()}</span>
                        </div>
                      )}
                    </div>
                  </div>
