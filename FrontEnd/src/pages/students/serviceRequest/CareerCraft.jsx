...
function CareerCraft() {
  const [features, setFeatures] = useState([
    {
      ...
      description: "Get a customized career roadmap based on your skills, interests, and market demand to chart your professional journey.",
      icon: <Target className="h-6 w-6" />
    },
    {
      id: 2,
      title: "Skill Development",
      description: "Identify and develop the skills you need to reach your career goals with our comprehensive analysis tools.",
      icon: <TrendingUp className="h-6 w-6" />
    },
    {
      id: 3,
      title: "Professional Certification",
      description: "Receive expert advice on the most valuable certifications for your career path and industry.",
  ...
  const addFeature = () => {
    const newFeature = {
      ...
      title: 'Additional Career Service',
      description: 'Expand your career development with our additional specialized services tailored to your needs.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#667eea]/5 via-[#f093fb]/5 to-[#764ba2]/5 overflow-hidden">
      <div className="container mx-auto px-4 max-w-6xl flex flex-col py-8">
        ...
        <header className="mb-8 pt-2 text-center">
          <div className="flex items-center justify-center gap-3">
            <div className="p-2 bg-gradient-to-br from-[#667eea]/20 to-[#764ba2]/20 rounded-lg">
              <Star className="h-6 w-6 text-[#667eea]" />
            </div>
            <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent">
              CareerCraft Professional Development
            </h1>
          </div>
          <p className="text-sm text-gray-600 mt-4 max-w-2xl mx-auto">
            Transform your career journey with our comprehensive suite of professional development services.
          </p>
        </header>

        {/* Feature Cards - Exactly 3 cards like MockInterview */}
        ...
        {/* Add Feature Button - Centered below cards */}
        <div className="text-center mb-10">
          <button
            onClick={addFeature}
            className="bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white px-8 py-3.5 rounded-lg font-medium hover:shadow-lg hover:shadow-[#667eea]/30 transition-all duration-200"
          >
            Add More Services
          </button>
        </div>
