                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <label htmlFor="agreeToTerms" className="text-sm text-gray-600">
                      I accept the <span className="text-[#667eea] font-medium hover:underline cursor-pointer">Terms of Service</span> and <span className="text-[#667eea] font-medium hover:underline cursor-pointer">Privacy Policy</span>. I understand that this mock interview session is confidential.
                    </label>
                  </div>
                </div>
              </div>
