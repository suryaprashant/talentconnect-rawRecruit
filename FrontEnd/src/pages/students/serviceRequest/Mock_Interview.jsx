            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="border border-gray-300 rounded-lg bg-white p-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full p-2 border border-gray-300 rounded bg-transparent focus:outline-none focus:ring-2 focus:ring-[#143694]/30 focus:border-[#143694]"
                    />
                    {isDropdownVisible && (
                        ...
                        {suggestedSkills
                          ...
                          .map((skill) => (
                            <div
                              ...
                              className="px-4 py-2 hover:bg-gradient-to-r hover:from-[#143694]/5 hover:to-[#1e4ed8]/5 cursor-pointer text-sm text-gray-700 hover:text-[#5b21b6]"
                            >
                              {skill}
                            </div>
                          ))}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-300 rounded-lg p-4 bg-white focus:outline-none focus:ring-2 focus:ring-[#143694]/30 focus:border-[#143694] h-32 resize-none"
                ></textarea>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <label htmlFor="agreeToTerms" className="text-sm text-gray-600">
                      I accept the <span className="text-[#143694] font-medium hover:underline cursor-pointer">Terms of Service</span> and <span className="text-[#143694] font-medium hover:underline cursor-pointer">Privacy Policy</span>. I understand that this mock interview session is confidential.
                    </label>
                  </div>
                </div>
              </div>
