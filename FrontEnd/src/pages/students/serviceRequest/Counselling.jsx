                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <label htmlFor="terms" className="text-sm text-gray-600">
                      I accept the <span className="text-[#143694] font-medium hover:underline cursor-pointer">Terms of Service</span> and <span className="text-[#143694] font-medium hover:underline cursor-pointer">Privacy Policy</span>. I understand that this counselling session is confidential and will be conducted professionally.
                    </label>
                  </div>
                </div>
              </div>
