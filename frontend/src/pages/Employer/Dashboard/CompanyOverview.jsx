...
//         {/* Company Description */}
//         <div className="mb-6">
//           <h2 className="text-xl font-bold mb-2">Employee Description</h2>
...
//                 This section displays the primary recruiter's contact information.
//               </p>
//             </div>
...
//             <div className="p-6 border-r">
//               <h3 className="font-bold mb-3">Company Details</h3> {/* Changed from Employee Detail */}
//               <p className="text-gray-600 text-sm">
//                 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros.
//               </p>
//             </div>
...
//                 <div className="col-span-2">Corporate/House</div> {/* Assuming this is placeholder for company name */}
                
//                 <div className="font-medium">Company location:</div> {/* Corrected typo */}
//                 <div className="col-span-2">IT Services & Consulting</div> {/* Assuming this is placeholder for industry */}

//                 <div className="font-medium">Company Location:</div>
//                 <div className="col-span-2">wadala</div> {/* Placeholder for actual location */}

//                 <div className="font-medium">State:</div>
//                 <div className="col-span-2">goa</div> {/* Placeholder for actual location */}

//                 <div className="font-medium">City:</div> {/* Added colon for consistency */}
//                 <div className="col-span-2">mumbai</div> {/* Placeholder for actual location */}

//                 <div className="font-medium">Country:</div> {/* Added colon for consistency */}
//                 <div className="col-span-2">India</div> {/* Placeholder for actual location */}

//                 <div className="font-medium">Pincode:</div>
//                 <div className="col-span-2">-</div> {/* Placeholder for actual pincode */}
...
//               <p className="text-gray-600 text-sm">
//                 This section outlines the types of roles and employment the company is seeking.
//               </p>
//             </div>
...
//                 <div className="col-span-2">-</div> {/* Will be populated from multiple-select */}
