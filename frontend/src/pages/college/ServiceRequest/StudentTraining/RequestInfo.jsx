...
const handleSubmit = async (e) => {
  ...
  try {
    const response = await axios.post(
      'http://localhost:8081/api/rawrecruit/student-training/register',
      payload
    );
    ...
    <div className="flex justify-center items-center min-h-screen bg-white px-4">
      <div className="max-w-3xl w-full">
        ...
        <div className="bg-white p-6 rounded-lg shadow border max-w-md mx-auto">
          <h2 className="text-xl font-bold mb-2 text-center">Request info for Student Training Programs</h2>
