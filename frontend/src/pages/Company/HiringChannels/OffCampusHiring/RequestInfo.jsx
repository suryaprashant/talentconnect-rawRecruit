...
//   try {
//     const response = await axios.post(`${BackendUrl}/api/company/offCampusRegister`, payload, {
//       headers: {
...
//  const [formData, setFormData] = useState({
//  location: '',
//  studentStream: '', // Changed to a string to match select element
//     criteria: '',
//     minimumPackage: '',
//     workLocation: '', // Changed to a string to match select element
//     jobRole: '', // Changed to a string to match select element
//     workMode: 'Hybrid',
//     employmentType: 'Full-time',
//     startDate: '',
//     endDate: '',
...
//     venue: formData.location, // 'location' from form is the 'venue' in schema
//     studentStreams: formData.studentStream ? [formData.studentStream] : [],
//     description: formData.criteria, // 'criteria' from form is 'description' in schema
//     minPackage: {
//       currency: 'INR',
//       amount: parseFloat(formData.minimumPackage) || 0
//     },
//     location: formData.workLocation ? [formData.workLocation] : [], // 'workLocation' from form is 'location' in schema
//     jobRoles: formData.jobRole ? [formData.jobRole] : [],
//     workMode: formData.workMode, // Sending as a string, not an array
//     employmentType: formData.employmentType, // Sending as a string, not an array
...
//     contactPerson: formData.contactPerson,
//     minimumStudents: formData.minimumStudents, // Sending as a string, not a number
//   };

//   try {
//     const response = await axios.post(`${BackendUrl}/api/hiring-channels/off-campus`, payload, {
//       headers: {
//         'Content-Type': 'application/json',
//       },
//       withCredentials: true,
