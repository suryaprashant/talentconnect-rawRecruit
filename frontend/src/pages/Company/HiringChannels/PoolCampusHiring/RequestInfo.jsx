...
export default function OffCampusHiringForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_Backend_URL}/api/hiringDrive/poolCampus-register`,
        submissionData,
        {
          headers: {
  ...
  //         <span className="block sm:inline"> Your pool campus hiring request has been submitted successfully.</span>
  //       </div>
  //     </div>
  //   );
  // }
