...
import { EditFresherStepFour } from "./EditFresherStepFour";
import { EditProfessionalStepFour } from "./EditProfessionalStepFour";
...
export const EditStepFour = ({ onNext, onBack }) => {
  ...
  useEffect(() => {
    ...
    if (roleFromStorage) {
      setSelectedRole(roleFromStorage.toLowerCase());
    }
  }, []);
  ...
  const getPageTitle = () => {
    switch (selectedRole) {
      case 'fresher':
        return "Great! Let's set up your career preferences!";
      case 'professional':
        return "Excellent! Let's define your career goals and experience!";
      case 'student':
      default:
        return "Awesome! Let's define your career goals and skills!";
    }
  };
  ...
  const getPageDescription = () => {
    switch (selectedRole) {
      case 'fresher':
        return "Share your interests and preferences to help us find the perfect entry-level opportunities for you.";
      case 'professional':
        return "Tell us about your experience and career aspirations so we can recommend the best opportunities.";
      case 'student':
      default:
        return "Let us know your job interests and preferred locations so we can recommend the best opportunities for you.";
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="justify-center items-stretch flex min-w-60 flex-col w-[560px] my-auto p-12 max-md:max-w-full max-md:px-5">
        ...
        <div className="flex w-full flex-col items-stretch justify-center mt-8 max-md:max-w-full">
          ...
          {/* Action Buttons - Show for all roles */}
