...
//     if (updates.leadership) updates.leadership = JSON.parse(updates.leadership);
//     if (updates.internationalExperience) updates.internationalExperience = JSON.parse(updates.internationalExperience);
//     if (updates.awards) updates.awards = JSON.parse(updates.awards);
...
//     // Handle leadership certificates (multiple)
//     if (files?.leadershipCertificate && updates.leadership) {
//       const leadershipCerts = files.leadershipCertificate;
//       for (let i = 0; i < updates.leadership.length && i < leadershipCerts.length; i++) {
//         const uploadedCert = await streamUpload(
//           leadershipCerts[i].buffer,
//           "leadershipCertificates"
//         );
//         updates.leadership[i].certificate = uploadedCert.secure_url;
//       }
//     }
//     // Handle international experience certificates (multiple)
//     if (files?.internationalExperienceCertificate && updates.internationalExperience) {
//       const internationalCerts = files.internationalExperienceCertificate;
//       for (let i = 0; i < updates.internationalExperience.length && i < internationalCerts.length; i++) {
//         const uploadedCert = await streamUpload(
//           internationalCerts[i].buffer,
//           "internationalExperienceCertificates"
//         );
//         updates.internationalExperience[i].certificate = uploadedCert.secure_url;
//       }
//     }

//     // Handle award certificates (multiple)
//     if (files?.awardCertificate && updates.awards) {
//       const awardCerts = files.awardCertificate;
//       for (let i = 0; i < updates.awards.length && i < awardCerts.length; i++) {
//         const uploadedCert = await streamUpload(
//           awardCerts[i].buffer,
//           "awardCertificates"
//         );
//         updates.awards[i].certificate = uploadedCert.secure_url;
//       }
//     }
