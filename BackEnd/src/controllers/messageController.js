import { createMessage, getMessagesForConversation , findOrCreateConversation, getUnreadMessageCounts, getSortedUsersByConversation } from "../services/chatFeatureService.js";
...
export const getMessage = async (req, res) => {
    try {
        ...
        const messages = await getMessagesForConversation({ userId, chatPartnerId });
