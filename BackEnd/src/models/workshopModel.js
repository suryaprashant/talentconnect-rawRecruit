...
const WorkshopSchema = new mongoose.Schema({
    title: {
        ...
        trim: true,
        maxlength: [100, 'Workshop title cannot be more than 100 characters']
    },
    subTitle: {
        type: String,
        trim: true,
    ...
    workshopType: {
        type: String,
        required: [true, 'Please specify the workshop type'],
    ...
    venue: {
        type: String,
        required: function () {
            return this.workshopType !== 'Virtual';
        },
...
// Same pre-validate hook for dates
...
// Same pre-save hook for domains
